...
public class DeviceListActivity extends Activity {
    ...
    private HashMap<String, UsbDevice> usbPrinterMap = new HashMap<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Initialize the button to perform device discovery6
...
//        });
        ...
        mFoundDevicesArrayAdapter = new ArrayAdapter<>(this, R.layout.device_name);
        // mNewDevicesArrayAdapter = new ArrayAdapter<String>(this, R.layout.device_name);

        // Find and set up the ListView for paired devices
        mFoundDevicesListView = findViewById(R.id.paired_devices);
